...
class NumericalIntegrator:
    ...
    def __init__(self, integrationType):
        ...
        elif integrationType == "MonteCarlo":
            printError("You do not need a numerical integrator for Monte Carlo simulations. Please consider the type of simulation you want and the theory behind it")
            raise TypeError
        else:
