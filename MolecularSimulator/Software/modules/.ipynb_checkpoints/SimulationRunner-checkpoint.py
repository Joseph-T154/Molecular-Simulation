...
class SimulationRunner:
    ...
    def runSimulation(self, pSys, params, box, fw, equilibrationTime, numericalIntegrator, thermal=True, elastic=True, lj=True, kinetics=True, frameRate = None):
        ...
        for step in range(numStepsRequired):
            ...
            # Elastic forces for all springs / bonds
            if elastic:
                pSys.applyElasticForces(params)
    ...
    def runThermalEquilibration(self, pSys, params, box, fw, equilibrationTime, numericalIntegrator):
        ...
        self.runSimulation(pSys, params, box, fw, equilibrationTime, numericalIntegrator, thermal=True, elastic=True, lj=False, kinetics=False)
    ...
    def runLJEquilibration(self, pSys, params, box, fw, equilibrationTime, numericalIntegrator):
        ...
        self.runSimulation(pSys, params, box, fw, equilibrationTime, numericalIntegrator, thermal=False, elastic=True, lj=True, kinetics=False)
    ...
    def runThermalLJEquilibration(self, pSys, params, box, fw, equilibrationTime, numericalIntegrator):
        ...
        self.runSimulation(pSys, params, box, fw, equilibrationTime, numericalIntegrator, thermal=True, elastic=True, lj=True, kinetics=False)

    def runProduction(self, pSys, params, box, fw, equilibrationTime, numericalIntegrator, thermal=True, elastic=True, lj=True, kinetics=False, frameRate = None):

        # Write equilibration step details to the files
        fw.writeStage("Production")

        self.runSimulation(pSys, params, box, fw, equilibrationTime, numericalIntegrator, thermal=thermal, elastic=elastic, lj=lj, kinetics=kinetics, frameRate = frameRate)